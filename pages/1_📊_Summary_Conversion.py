...
st.title("📊 Summary: Conversion Ratio")
st.caption("Per CRE/RM breakdown — Fresh, Renewal, and Expanded business")
...
# ---- Table ----
st.subheader("Conversion Ratio Detail")
